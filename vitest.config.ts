...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@agentic/db/auth-runtime-schema": path.resolve(projectRoot, "packages/db/src/auth-runtime-schema.ts"),
      "@agentic/db/migration-discipline": path.resolve(projectRoot, "packages/db/src/migration-discipline.ts"),
      "@agentic/db/migration-runtime": path.resolve(projectRoot, "packages/db/src/migration-runtime.ts"),
      "@agentic/db/schema-status": path.resolve(projectRoot, "packages/db/src/schema-status.ts"),
      ...
      "@agentic/integrations/client": path.resolve(projectRoot, "packages/integrations/src/client.ts"),
      ...
      "@agentic/repository/job-claim": path.resolve(projectRoot, "packages/repository/src/repository-job-claim.ts"),
      "@agentic/repository/runtime-helpers": path.resolve(projectRoot, "packages/repository/src/repository-runtime-helpers.ts"),
      "@agentic/repository/watcher-lease": path.resolve(projectRoot, "packages/repository/src/watcher-lease-helpers.ts"),
      "@agentic/repository/autopilot-event-claim": path.resolve(projectRoot, "packages/repository/src/autopilot-event-claim-helpers.ts"),
