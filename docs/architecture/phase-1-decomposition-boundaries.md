...
- named repository ports for queue, dashboard read, dashboard collection read, dashboard event stream read, governance, credential, memory, watcher, privacy, share/audit, template, agent catalog, product, and worker-runtime consumers
