...
- `0012_llm_cache.sql`: Adds the LLM response cache table and expiry index. Roll back by disabling repository-backed LLM caching first; dropping the table only removes cached responses and must not be used to remove source-of-truth state.
